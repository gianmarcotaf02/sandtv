            ...
            <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 px-3 py-2 text-xs font-medium rounded-lg transition-colors flex items-center justify-center gap-2 ${
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                Scegli il tema dell'interfaccia. Il tema scuro riduce l'affaticamento degli occhi in ambienti bui.
              </p>
            </div>
          </div>
        </div>
